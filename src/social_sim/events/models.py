...
class EventType(str, Enum):
    ...
    LEISURE_STARTED = "LEISURE_STARTED"
    PERSONAL_CARE_STARTED = "PERSONAL_CARE_STARTED"
    CHORES_STARTED = "CHORES_STARTED"
    SLEEP_COMPLETED = "SLEEP_COMPLETED"
    WORK_COMPLETED = "WORK_COMPLETED"
    LEISURE_COMPLETED = "LEISURE_COMPLETED"
    PERSONAL_CARE_COMPLETED = "PERSONAL_CARE_COMPLETED"
